	...
	<div>
		...
		<table border="1">
			<tr>
				...
				<td>
					개별점수.  <br>
					${board.score_name1} : ${board.score_grade1} <br>
					${board.score_name2} : ${board.score_grade2} <br>
					${board.score_name3} : ${board.score_grade3} <br>
					${board.score_name4} : ${board.score_grade4} <br>
				</td>
			</tr>
		</table>
		<br><br>
