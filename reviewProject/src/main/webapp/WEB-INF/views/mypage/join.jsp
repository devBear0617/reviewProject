		...
		<form action="/review/mypage/join" method="POST" id="joinMember"
			...
			<table class="center">
				...
				<tr>
					...
					<td class="td_st2"><input type="text" id="id" class="ID"
						maxlength="12"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="td_st2"><input type="password" class="text_st_pw"
						id="pw" maxlength="12"></td>
				</tr>
				<tr>
					<td colspan="2" class="td_st3"><span
						style="font-size: small; color: gray;">*4~12자리의 영문 대소문자와
							숫자로만 입력</span></td>
				</tr>
				<tr>
					<td class="td_st1">PW-CHECK</td>
					<td class="td_st2"><input type="password" name="member_pw"
						class="text_st_pw" id="pwck" maxlength="12"></td>
				</tr>

				<!-- NAME -->
				<tr>
					<td class="td_st1">NAME</td>
					<td class="td_st2"><input type="text" id="name" class="NM">
					</td>
				</tr>
				<tr>
					<td colspan="2" class="td_st3">
				...
				<tr>
					<td colspan="2"><input type="button" value="취소"
						class="btn_st1" onclick="window.location.reload()"></td>
				</tr>
				<tr>
					<td colspan="2"><hr></td>
				</tr>
